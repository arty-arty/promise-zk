...
* @returns {string}
*/
export function vkey_serialize(vkey) {
    try {
...
* @returns {any}
*/
export function vkey_prepared_serialize(vkey) {
    const ptr0 = passStringToWasm0(vkey, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
* @returns {string}
*/
export function proof_serialize(proof) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {string}
*/
export function public_input_serialize(public_input) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
